...
static partial class Program
{
    internal static void MapCustomers(this WebApplication app)
    {
        ...
        app.MapGet(
            ...
            handler: async (string country, ICustomerRepository repo) =>
            {
                return (await repo.RetrieveAllAsync())
        ...
        app.MapPut(
            ...
            handler: async Task<IResult> (Customer c, string id, ICustomerRepository repo,
        ...
        app.MapDelete(
            pattern: "/customers/{id}", 
            handler: async Task<IResult> (string id, ICustomerRepository repo,
            CancellationToken token = default) =>
          {
